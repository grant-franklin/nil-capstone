...
The competitive balance question is more complicated. In football, the gap widened - Power conference teams went from winning at a rate 6.2 percentage points higher than Group of 5 teams before NIL to 8.0 percentage points higher after, and their SRS advantage grew from 5.6 to 7.2. But men's basketball moved in the opposite direction. Power conference teams actually got slightly worse post-NIL (58.8% win rate vs. 59.4% pre-NIL), while High-Major programs gained 1.5 percentage points. Women's basketball was essentially flat. The competitive effect of NIL is sport-dependent, not universal.`,
  },
  {
    id: 2,
    number: "02",
